...
/*
const char * get_string_regexp(const char * pattern, const char * str){
	...
	if(x) {
		//trex_sprintf(sTemp,_TREXC("ABCD +CLIP: \"0744805102\" EFGHIJ"));
		trex_sprintf(sTemp,_TREXC(str));
