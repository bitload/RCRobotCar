...
void  _get_temp_int(int8_t* i, uint8_t* f)
{
	uint8_t msb, lsb;
...
const char * rtc_get_weekday(const uint8_t wday){
	const char * wdch;
	
	switch (wday)
	{
		case 1: wdch = "Mon"; break;		
		case 2: wdch = "Tue"; break;
		case 3: wdch = "Wed"; break;
		case 4: wdch = "Thu"; break;
		case 5: wdch = "Fri"; break;
		case 6: wdch = "Sat"; break;
		case 7: wdch = "Sun"; break;
	}
